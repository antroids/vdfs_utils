...
use crate::vdfs::{Vdfs, data_source};
...
fn main() {
    ...
    println!("Unpacking vdfs filesystem from {} to folder: {}", &input_path, &output_path);
    ...
    vdfs.init_current_base_table().expect("Cannot initialize base table");
